    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.titleSearchContainer}>
          <h1 className={styles.title}>ค้นหาสินค้า ส่งฟรีทวีวัฒนา</h1>
          <input
            type="text"
        ...
        {activeTab === 'products' && (
          <>
            <div className={styles.filterSection}>
              {['', 'บรรจุภัณฑ์อาหาร-เบเกอรี่','บรรจุภัณฑ์เครื่องดื่ม', 'วัตถุดิบเบเกอรี่','วัตถุดิบเครื่องดื่ม', 'เครื่องเขียน' ].map(type => (
                <button
                  key={type}
