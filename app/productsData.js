...
const initialProducts = [
    ...
    { name: 'ชาตรามือ ชาแดงอัสสัม 250 ก.', price: '110฿',type:'วัตถุดิบ', quantity: 1, image: '/images/ชาตรามือ ชาแดง.jpg' },
    { name: 'น้ำตาลทรายแดงมิตรผล 1 kg.', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/ทรายแดงมิตรผล.jpeg' },
    { name: 'น้ำตาลทรายขาวมิตรผล 1 kg.', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/น้ำตาลทรายขาว 1 kg.jpg' },
    ...
    { name: 'น้ำเชื่อมลองบีชสตรอเบอรี่', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/LBStrawberry.jpg'},
    { name: 'น้ำเชื่อมลองบีชอัลม่อนอบ', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/LBRoastedAlmond.jpg'},
    { name: 'น้ำเชื่อมลองบีชเฮเซลนัท', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/LBHazelnut.jpg'},
    { name: 'น้ำเชื่อมลองบีชทิรามิสุ', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/LBTiramisu.jpg'},
    { name: 'น้ำเชื่อมลองบีชช็อคโกแลต', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/LBChocolate.jpg'},
    { name: 'น้ำเชื่อมลองบีชราสเบอรี่', price: '41฿',type:'วัตถุดิบ', quantity: 1, image: '/images/LBRaspberry.jpg'},
